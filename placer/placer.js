...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "placer.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "placer.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'placer'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'placer':", error );
                    throw error;
                });
        }
    }( function() {
...
addCss('game-screen.css');
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_900fb8883876f36b2a5bed6439efbecaf3003823": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return($1).exitFullscreen();})());
            },
            ...
            "__cargo_web_snippet_f4fc1575d9f7adca6f4bef75f8919a59c2e5dcb7": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return[window.screen.width,window.screen.height];})());
            },
